      ...
      <div className="container mx-auto px-4 pt-20 pb-16">
        ...
        <section className="max-w-4xl mx-auto text-center pt-8 pb-16">
          <div className="inline-flex items-center justify-center p-2 bg-blue-500/10 rounded-full mb-6 border border-blue-500/30">
            ...
            <span className="text-sm text-blue-300">100% Free for Students</span>
          </div>
            ...
            {gradeStandards.map((item, i) => (
              <Card key={i} className="bg-slate-800/50 border-slate-700 text-center">
                <CardContent className="pt-6">
                  <p className="text-lg font-bold text-blue-400">{item.grade}</p>
                  <p className="text-3xl font-bold text-white mt-2">{item.wpm}</p>
                  <p className="text-sm text-slate-400">WPM</p>
                  <p className="text-green-400 mt-2">{item.accuracy}</p>
