        ...
        <div className="relative min-h-[200px] md:min-h-[300px] max-h-[300px] md:max-h-[400px] overflow-hidden group">
          ...
          {!freestyleMode && text && (
            <div
              ...
              className={cn(
                "relative w-full h-full max-h-[300px] md:max-h-[400px] overflow-y-auto p-4 md:p-8 text-lg sm:text-xl md:text-3xl font-mono leading-relaxed outline-none transition-all duration-300 scroll-smooth select-none",
