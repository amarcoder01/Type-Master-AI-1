  ...
  return (
    <Card className="border-border/50 bg-card/50 backdrop-blur-sm overflow-hidden">
      <CardContent className="p-0">
        ...
        {/* Header Skeleton */}
        {showHeader && (
          <div className="hidden md:grid grid-cols-6 gap-4 p-3 md:p-4 bg-muted/30 border-b border-border/50">
        ...
        <div className="divide-y divide-border/50">
          {Array.from({ length: rows }).map((_, index) => (
            <div key={index} className="p-3 md:p-4" style={{ animationDelay: `${index * 50}ms` }}>
              ...
              <div className="hidden md:grid grid-cols-6 gap-4 items-center">
                ...
                {/* WPM */}
                <div className="flex justify-center">
                  <div className="h-6 w-12 rounded bg-primary/20 animate-pulse" />
                </div>
